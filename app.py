        ...
        if name == "" or city == "":
            ...
            <div class="certificate-box">
                ...
                <div class="certificate-text" style="margin-top:12px; font-size:14px; color:#777;">
                    You can take a screenshot 📸 to keep this certificate!
                </div>
            </div>
            """
            st.markdown(cert_html, unsafe_allow_html=True)

            # --------- OPTIONAL: PDF DOWNLOAD IF REPORTLAB IS AVAILABLE ---------
            if REPORTLAB_AVAILABLE:
                ...
                st.info("PDF download is not available on this server, but you can still take a screenshot of your certificate 😊")
